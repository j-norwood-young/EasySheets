							...
							{#if isRowEditable(row.id)}
								...
								{:else}
									...
									<input
										...
										class="w-full rounded border border-zinc-200 bg-white px-2 py-1.5 text-zinc-900 focus:border-zinc-400 focus:ring-1 focus:ring-zinc-400 focus:outline-none"
									/>
								{/if}
							{:else}
