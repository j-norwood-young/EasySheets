	...
	<main class="mx-auto max-w-2xl px-4 py-16">
		<div class="text-center">
			...
			<p class="mt-1 text-sm text-zinc-400">
				Use UTF-8 encoding for accents and special characters.
			</p>
		</div>
		...
		{#if mySheets.length > 0}
			<section
				...
				aria-labelledby="your-sheets-heading"
			>
				<h2 id="your-sheets-heading" class="text-center text-lg font-medium text-zinc-800">
					Your sheets
				</h2>
				<p class="mt-1 text-center text-sm text-zinc-500">
					Sheets you've created or edited (by last opened)
				</p>
						...
						>
							...
							>
								<span class="font-medium text-zinc-800"
									>{sheet.name || 'Untitled sheet'}</span
								>
